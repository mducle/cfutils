...
chi2bp = fit_scipy.fit_en(fit, [[0, 0.7, 7.5, 30.35, 32.2], [0, 1.3, 12.2, 31.0]], eval_only=bp, 
    widths_kwargs={'maxfwhm':[0.75, 7.0, 10.0], 'method':'trust-constr', 'jac':'3-point', 'options':{'maxiter':10}})
cfpars, cfobjs, peaks, intscal, origwidths = fit_scipy.parse_cef_func(fit.model.function)
fit_scipy.genpp(fit)
